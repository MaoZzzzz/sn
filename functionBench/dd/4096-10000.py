...
user_result_riscv, idle_result_riscv, iowait_result_riscv = read_file("4096", "10000", "cpu", "riscv")
bread_result_riscv, bwrite_result_riscv = read_file("4096", "10000", "io", "riscv")
user_result_x86, idle_result_x86, iowait_result_x86 = read_file("4096", "10000", "cpu", "x86")
bread_result_x86, bwrite_result_x86 = read_file("4096", "10000", "io", "x86")
...
# plt.show()
plt.savefig("./picture/4096-10000.jpg")
